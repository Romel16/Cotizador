...
function editar(prod_id){
    ...
    $.ajax({
        url: "../../controllers/productoControllers.php?op=mostrar",
        data: { productoId: prod_id },
        type: "POST",
        dataType: "json",
        beforeSend: function() {
        ...
        success: function(data) {
            setTimeout(function() {
                ...
                $('#categoriaId').val(data.productoCategoriaId).trigger("change");
...
function eliminar(prod_id){
    swal({
        ...
        if (isConfirm) {
            $.ajax({
            url: "../../controllers/productoControllers.php?op=eliminar",
            type: "POST",
            data: { productoId: prod_id },
            beforeSend: function() {
